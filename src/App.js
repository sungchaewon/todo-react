...
class App extends React.Component { 
 ...
 items :[ 
  ...
  {id:"todo1", title:"Todo 2 ", done:false}, ], }; } // add 함수 추가
 add =(item)=>{ const thisItems =this.state.items;
...
// delete 함수 추가. (alt+shift+f 포맷팅)
 ...
 render(){ 
  ...
  // totoItem = this.state.items.length > 0 ? (<Paper></Paper>):""; 이렇게 해도 같은 결과이다. 
  //조건선택문 ? ternary operator
